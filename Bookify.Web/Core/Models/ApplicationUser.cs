...
namespace Bookify.Web.Core.Models
{
    ...
    [Index(nameof(UserName),IsUnique =true)] //لاحظ ان الاميل و اسم المستخدم غير موجودين في هذا الكلاس ولكن موجودين في الكلاس الاساسي اللي هو ال IdentityUser ولو مش وارث من الكلاس الاساسي هيديك هنا خطأ...  
